    ...
    <section>
        <div class="center-box">
            ...
            <span class="placement-button">
                ...
                <?php else: ?>
                    <div tabindex="3" class="message">Désolé ! Ce jeux n'est plus disponible en stock.</div>
                <?php endif; ?>
            </span>
        ...
        <div class="textfield">
            ...
            <div class="auteur">
                <p tabindex="4">par <?php e($editor); ?> sur <?php e($plateform); ?></p>
            </div>
            <p tabindex="4">genre: <?php e($genre); ?></p>
            <p tabindex="4">pegi: <?php e($pegi); ?></p>
            <p tabindex="2">description:</p>
            <div tabindex="2" class="scroll-box"><?php e($description); ?> </div>
        </div>
    </section>
</div>
