    ...
    <div class="auth-card">
        ...
        <form method="POST" class="auth-form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" required placeholder="Titre du jeu" value="<?php if (isset($entries['title'])) echo htmlspecialchars( $entries['title']);?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="editor" name="editor" required placeholder="Éditeur" value="<?php if (isset($entries['editor'])) echo htmlspecialchars( $entries['editor']);?>">
            </div>
            ...
            <div class="form-group">
                ...
                <select id="pegi" name="pegi" required value="<?php if (isset($entries['pegi'])) echo htmlspecialchars( $entries['pegi']);?>">
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" placeholder="Description"><?php if (isset($entries['description'])) echo htmlspecialchars( $entries['description']);?></textarea>
            </div>
